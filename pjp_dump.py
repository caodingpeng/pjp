...
def dump_class(class_):
    ...
    print('  Methods:')
    for method in list(class_.methods.values()):
        print('    %s' % method)
    ...
    print('  Fields:')
    for field in list(class_.fields.values()):
        print('    %s' % field)
...
def main():
    ...
    parser.add_argument('jar_file', help='class directory')
    ...
    jarfile = JarFile(args.jar_file)
    for jclass in jarfile.classes:
